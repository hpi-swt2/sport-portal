$( document ).on('turbolinks:load', function() {
    $('#event_deadline').datepicker({autoclose: true, startDate: new Date()});
    $('#event_startdate').datepicker({autoclose: true, startDate: new Date()});
    $('#event_enddate').datepicker({autoclose: true, startDate: new Date()});
