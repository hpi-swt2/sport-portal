...
class Event < ApplicationRecord
  ...
  validates :max_teams, numericality: { greater_than_or_equal_to: 0, allow_nil: true } # this validation will be moved to League.rb once leagues are being created and not general event objects
