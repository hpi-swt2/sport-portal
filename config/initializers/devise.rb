...
Devise.setup do |config|
  ...
  # When running in production, Devise requires this to be set explicitly
  # Read the 'secret_key_base' from 'config/secrets.yml'
  config.secret_key = Rails.application.secrets.SECRET_KEY_BASE.to_s

  # ==> Mailer Configuration
  # Configure the e-mail address which will be shown in Devise::Mailer,
  # note that it will be overwritten if you use your own mailer class
  # with default "from" parameter.
  config.mailer_sender = 'sport.portal@gmx.de'
  ...
  # config.pepper = 'ee520266cdb1f3f293d63889c18c45253e0f1eacb2d7efbf38328b7ed50640707d698ec277ebe5a24ec45c18d417fef49fb58bca0256c073a2504572c372c019'
  ...
  # a value bigger than 0 is required here for all our tests to work
